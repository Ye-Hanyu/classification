class DefaultConfigs(object):
    ...
    dataset = "/home/ye/pytorch_img_classification_for_competition-master/data"  # dataset folder with train and val
    test_folder =  "/home/ye/pytorch_img_classification_for_competition-master/data/test"      # test images' folder
    submit_example =  "/home/ye/pytorch_img_classification_for_competition-master/submits/submit_example.csv"    # submit example file
    ...
    input_size = 256      # model input size or image resied
    num_classes = 5       # num of classes
    gpu_id = "0"          # default gpu id
    model_name = "se_resnext50_32x4d-model-sgd-256"      # model name to use
